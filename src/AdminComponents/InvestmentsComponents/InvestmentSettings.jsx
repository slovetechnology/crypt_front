            ...
            <div className='xl:w-1/3 lg:w-2/5 md:w-1/2 w-10/12 bg-white rounded-lg overflow-hidden relative' ref={toggler}>
                ...
                <div className='relative'>
                    <div className='flex flex-col gap-4 py-6 px-2'>
                        <div className='md:text-xl text-lg uppercase text-center font-bold border-b w-full mb-2'>investment settings</div>
                        ...
                        <div className='flex flex-col gap-2 mt-4 text-sm items-center'>
