    ...
    return (
        <div className={`pt-10 pb-24 lg:pb-10 ${screen === 2 ? 'h-screen' : 'h-fit'}`}>
            ...
            {screen === 1 && <div className='w-[80%] mx-auto my-10 relative flex items-center justify-center bgdeposit'>
                <div className={`h-[32rem] w-[32rem] bg-semi-white md:px-3 px-2 rounded-xl relative overflow-x-hidden shlz scroll thediv  ${modal ? 'overflow-y-hidden' : 'overflow-y-auto'}`}>
