                ...
                <form onSubmit={submitForm}>
                    <div className='flex flex-col gap-4'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <textarea placeholder='Type A Message' className={` p-2 h-36 text-semi-white lg:text-[0.9rem]  outline-none bg-[#0C091A] rounded-[3px] resize-none border  ${messageError === true ? 'border-[#972424]' : 'border-light'} ipt`} name='message' value={form.message} onChange={inputHandler}></textarea>
                        </div>
