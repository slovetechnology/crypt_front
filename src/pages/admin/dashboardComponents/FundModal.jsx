...
const FundModal = ({ closeView, setScreen, setUserDeposits, setDepositTitle, setStart, setEnd, setpagestart, setpageend, refetchWallet, refetchDeposits, refetchNotifications, refetchUnreadNotis }) => {
