                    ...
                    {!beforeshow && <div className='md:w-[90%] w-11/12 mx-auto md:py-8 py-4 flex flex-col gap-8 md:text-[0.9rem] text-[0.8rem]'>
                        ...
                        <div className='mt-4'>
                            {deleted === 1 && <div className='flex items-center justify-center'>
                                <button className='w-fit h-fit py-2 px-6 text-[0.85rem] capitalize bg-[#462c7c] rounded-lg text-white font-medium' onClick={() => { setDeleted(2); MoveToBottom() }}>delete user</button>
                            </div>}
                            {deleted !== 1 && <div className='w-fit h-fit md:p-8 px-2 py-4 rounded-md bg-white adsha mx-auto  text-black'>
