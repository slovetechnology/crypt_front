...
const UpdateDeposits = ({ refetchAllDeposits }) => {
  ...
  return (
    <div className='h-screen'>
      {modal && <UpdateDepositModal closeView={() => setModal(false)} singleDeposit={singleDeposit} setAllDeposits={setAllDeposits} setStart={setStart} setEnd={setEnd} setpagestart={setpagestart} setpageend={setpageend} setSearch={setSearch} setWrite={setWrite} refetchAllDeposits={refetchAllDeposits} />}
