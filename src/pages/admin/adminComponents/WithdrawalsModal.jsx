        ...
        <div className='w-full h-screen fixed  top-0 left-0 flex items-center justify-center bg-[#0000008a] z-20'>
            <div className={`bg-white rounded-lg lg:w-1/2 md:w-3/4 w-11/12 lg:h-[90vh] h-[80vh] ${loading ? 'overflow-hidden' : 'overflow-y-auto scroll'}  move`} ref={toggler}>
                <div className={`w-full h-full relative  ${beforeshow && 'flex items-center justify-center'}`}>
                    ...
                    {!beforeshow && <div className='md:w-[90%] w-11/22 mx-auto md:py-8 py-4 flex flex-col gap-8 md:text-[0.9rem] text-[0.8rem]'>
                            ...
                            <div className='md:w-5/6 w-11/12 mx-auto flex flex-col gap-4'>
                                ...
                                <div className='flex justify-between items-center'>
                                    ...
                                    <div className='flex gap-1 items-center'>
                                        ...
                                        <button className='outline-none w-fit h-fit py-2 px-2.5 text-[0.8rem] text-white bg-[#c9b8eb] rounded-md capitalize flex items-center justify-center' onClick={() => copyFunction()}>
                                        {!copy && <MdContentCopy />}
                                        {copy && <FaCheck />}
                                    </button>
                                    </div>
                        ...
                        {update && <div className='flex items-center justify-center -mt-4'>
                            <button className='w-fit h-fit py-[0.5rem] px-6 text-[0.85rem] capitalize bg-[#462c7c] rounded-lg text-white font-medium' onClick={AdminUpdateWithdrawal}>update details</button>
                        </div>}
                    </div>}
                </div>
            </div>
