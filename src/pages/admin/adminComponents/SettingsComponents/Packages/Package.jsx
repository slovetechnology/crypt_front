...
const Package = () => {
  ...
  return (
    <div className='mt-4'>
      {modal && <UpdatePackageModal closeView={() => setModal(false)} singlePlan={singlePlan} setTradingPlans={setTradingPlans} setStart={setStart} setEnd={setEnd} setpagestart={setpagestart} setpageend={setpageend} />}
      {modal2 && <CreatePackageModal closeView={() => setModal2(false)} setTradingPlans={setTradingPlans} setStart={setStart} setEnd={setEnd} setpagestart={setpagestart} setpageend={setpageend} />}
