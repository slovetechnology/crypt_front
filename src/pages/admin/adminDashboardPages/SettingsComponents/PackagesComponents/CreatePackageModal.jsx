                    ...
                    <div className='flex flex-col md:w-[90%] w-11/12 mx-auto py-4 md:text-[0.9rem] text-[0.8rem]'>
                        ...
                        <div className='flex flex-col gap-4 mt-4 relative'>
                            <div className='flex justify-between items-center'>
                                ...
                                <input className='outline-none border border-[#c9b8eb] md:w-48 w-40 py-1 px-2 md:text-sm text-base' value={form.title} name='title' onChange={inputHandler}></input>
                            </div>
                            <div className='flex justify-between items-center'>
                                <div className='italic'>price start:</div>
                                <div className='flex gap-0.5 items-center'>
                                    <div className='text-xs'>$</div>
                                    <input className='outline-none border border-[#c9b8eb] md:w-48 w-40 py-1 px-2 md:text-sm text-base' value={form.price_start} name='price_start' onChange={inputHandler}></input>
                                </div>
                            </div>
                            <div className='flex justify-between items-center'>
                                ...
                                <div className='flex gap-0.5 items-center'>
                                    <div className='text-xs'>$</div>
                                    <input className='outline-none border border-[#c9b8eb] md:w-48 w-40 py-1 px-2 md:text-sm text-base' value={form.price_limit} name='price_limit' onChange={inputHandler}></input>
                                </div>
                            </div>
                            <div className='flex justify-between items-center'>
                                ...
                                <div className='flex gap-0.5 items-center'>
                                    <div className='text-xs'>%</div>
                                    <input className='outline-none border border-[#c9b8eb] md:w-48 w-40 py-1 px-2 md:text-sm text-base' value={form.profit_percentage} name='profit_percentage' onChange={inputHandler}></input>
                                </div>
                            </div>
                            <div className='flex justify-between items-center'>
                                ...
                                <div className='flex gap-0.5 items-center'>
                                    <div className='text-xs'>$</div>
                                    <input className='outline-none border border-[#c9b8eb] md:w-48 w-40 py-1 px-2 md:text-sm text-base' value={form.plan_bonus} name='plan_bonus' onChange={inputHandler}></input>
                                </div>
                            </div>
                            <div className='flex justify-between items-center'>
                                <div className='italic'>duration:</div>
                                <input className='outline-none border border-[#c9b8eb] md:w-48 w-40 py-1 px-2 md:text-sm text-base' value={form.duration} name='duration' onChange={inputHandler}></input>
                            </div>
                            <div className='flex justify-between items-center'>
