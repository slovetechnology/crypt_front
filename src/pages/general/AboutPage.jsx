        ...
        <div className='w-11/12 mx-auto'>
          <div className='grid gap-8 grid-cols-1 lg:grid-cols-2'>
            <div className='col-span-1'>
              ...
              <div className='md:w-[70%] pt-[1.5rem] text-ground'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Suscipit accusamus, tenetur magni minus earum nihil neque, repellendus ullam aliquam alias pariatur aspernatur quam reiciendis debitis quibusdam similique molestias.</div>
