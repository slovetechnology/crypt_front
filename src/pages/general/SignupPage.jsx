                          ...
                          <div className='flex flex-col gap-[0.7rem] mt-[1rem]'>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 w-full md:gap-8 gap-[0.7rem]'>
                              <div className='flex flex-col gap-[0.3rem] relative '>
                                ...
                                <input className={`outline-none w-full  border-b focus:outline-none  ${userError === true ? 'border-[red]' : 'border-[#4d4c4c]'} text-sm ipt`} placeholder='Enter a username' type='text' name='username' value={form.username} onChange={inputHandler} ></input>
                                <div></div>
                              </div>
                              <div className='flex flex-col gap-[0.3rem] relative '>
                                <div className='text-sm capitalize font-[550] '>e-mail address:</div>
                                <input className={`outline-none w-full   border-b focus:outline-none   ${emailError === true ? 'border-[red]' : 'border-[#4d4c4c]'} text-sm focus:outline-none ipt`} placeholder='Enter your mail' type='email' name='email' value={form.email} onChange={inputHandler}></input>
                              </div>
                            </div>
                            <div className='grid grid-cols-1 md:grid-cols-2 md:gap-8 gap-[0.7rem] w-full'>
                              ...
                              <div className='flex flex-col gap-[0.3rem] relative'>
                                ...
                                <input className={`outline-none w-full   border-b focus:outline-none  ${codeError === true ? 'border-[red]' : 'border-[#4d4c4c]'} text-sm ipt`} placeholder='Seven characters long' type='text' name='tradersCode' value={form.tradersCode} onChange={inputHandler}></input>
