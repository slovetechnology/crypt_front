        ...
        <div className='w-[90%] mx-auto'>
          <div className='flex flex-col gap-3 items-center justify-center'>
            <div className=' flex items-center'>
              ...
              <span className='z-20 ml-[-3rem] font-bold capitalize text-[3rem]'>trading plans</span>
            </div>
            <div className='text-[1.1rem]'>- Below are the different trading plans on the AI Algorithm Trading System -</div>
          </div>
          <div className='flex flex-col gap-[8rem] mt-[6rem]'>
            <div className='flex gap-[2rem] w-full text-[#30465c]'>
              <div className='w-full h-[28rem] bg-[whitesmoke] rounded-md'>
              ...
              <div className='w-full h-[28rem] bg-[#30465c] rounded-md text-white shabox'>
              ...
              <div className='w-full h-[28rem] bg-[whitesmoke] rounded-md text-[#30465c]'>
                <div className='flex flex-col items-center p-[2.5rem]'>
            ...
            <div className='flex gap-[2rem] w-full'>
              ...
              <div className='w-full h-[28rem] bg-[#30465c] rounded-md shabox text-white'>
                <div className='mt-[1rem] '>
