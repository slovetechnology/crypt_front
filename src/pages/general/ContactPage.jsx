                ...
                {show !== 1 && <div className='flex flex-col gap-2 relative items-center'>
                  ...
                  <div className='flex gap-2 items-center'>
                    <div className='relative'>
                      <input className='outline-none border-b border-t-0 border-l-0 border-r-0  border-white bg-transparent text-[0.85rem] w-48 pl-4 text-white focus:outline-none' type='text' value={code} onChange={e => setCode(e.target.value)}></input>
